...
class Simple_Substition_Ciphers():
    ...
    def caeser_cipher(self, shifting_amount: int = 3)  -> str:
        ...
        self.text = self.input_text.upper()
    ...
    def random_substition(self) -> str:
        ...
        # create the substituted cipher
        self.encrypted_final_text = ''.join(self.encryption_letter_mapping[char] for char in self.input_text)
    ...
    def brute_force_caesers_cipher(self) -> list[str]:
        ...
        for shift in range(26):
            ...
            decrypted_final_text_example = ''.join(
                ...
                for char in self.input_text.upper()
            )
